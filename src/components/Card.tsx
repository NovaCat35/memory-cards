...
// Set regex so we can test if current imageSrc is 'paimon.webp'
...
function Card({ charName }: CardProps) {
	...
	const imageSrc = imageMap[charName] || paimonImage;

	/**
	 * This is so we don't show any TCG card image that isn't released yet as of date for fetched API character
	 */
